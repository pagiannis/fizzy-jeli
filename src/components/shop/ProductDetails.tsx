...
const ProductDetails = () => {
  ...
  return (
    <CardContainer width={7} className="p-0 m-0">
      ...
      <div className="flex flex-col lg:flex-row lg:gap-15 sm:p-6 min-h-[500px]">
        ...
        <div className="lg:order-2 lg:order-1 lg:w-1/2  rounded-lg flex flex-col lg:flex-row p-3 lg:p-10">
